...
BEGIN_MESSAGE_MAP(CwyytToolsApp, CWinApp)
...
// 唯一的一个 CwyytToolsApp 对象

CwyytToolsApp theApp;

CString g_strAppPath;
// CwyytToolsApp 初始化

BOOL CwyytToolsApp::InitInstance()
{
	...
	m_pszProfileName = _tcsdup(thePrefs.GetIniDirectory() + _T("preferences.ini"));
